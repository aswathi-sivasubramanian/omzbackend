...
class Sites(models.Model):
    ...
    X = models.DecimalField(max_digits=9, decimal_places=8, null=True,default="null")
    Y = models.DecimalField(max_digits=9, decimal_places=8, null=True,default="null")
    ...
    NTACode = models.IntegerField(null=True,default="null")
    NTAName = models.CharField(max_length=20, null=True,default="null")
